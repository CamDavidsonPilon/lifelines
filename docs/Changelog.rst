...
-  In regression models, the column names in ``confidence_intervals_``
   has changed to include the alpha value.
-  In regression models, some column names in ``.summary`` and
