...
cc_data  = rodar_radon(["radon", "cc",  "./lifelines/lifelines", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./lifelines/lifelines", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./lifelines/lifelines", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./lifelines/lifelines", "-j"])
